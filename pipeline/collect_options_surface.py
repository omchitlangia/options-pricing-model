...
Run from the project root:
    python -m pipeline.collect_options_surface
"""
...
from config.constants import (
    SURFACE_TICKERS,
    SURFACE_MAX_EXPIRIES,
    RAW_OPTIONS_SURFACE,
)

TICKERS      = SURFACE_TICKERS
MAX_EXPIRIES = SURFACE_MAX_EXPIRIES
OUTPUT_PATH  = RAW_OPTIONS_SURFACE
...
def collect_ticker(ticker: str, max_expiries: int) -> pd.DataFrame:
    """Collects call options for all available expiries for a single ticker."""
